...
export default function FirstNamesAllCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    setAll_first(initialValues.all_first);
    setPersian_first(initialValues.persian_first);
    setArab_first(initialValues.arab_first);
    setKurmanji_first(initialValues.kurmanji_first);
    setPakistani_first(initialValues.pakistani_first);
    setSorani_first(initialValues.sorani_first);
    setTurkish_first(initialValues.turkish_first);
    setUkrainian_first(initialValues.ukrainian_first);
    setGerman_first(initialValues.german_first);
    setGender_first(initialValues.gender_first);
    setErrors({});
  };
  const validations = {
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new FirstNamesAll(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "FirstNamesAllCreateForm")}
      {...rest}
    >
      <TextField
        label="All first"
